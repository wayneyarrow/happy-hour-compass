...
import { resendSubmissionSetupEmailAction, type ResendSetupEmailState } from "./actions";

const INITIAL_STATE: ResendSetupEmailState = {};

export default function ResendSetupEmailPanel({ submissionId }: { submissionId: string }) {
  const router = useRouter();

  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const boundAction = (resendSubmissionSetupEmailAction as any).bind(null, submissionId);
